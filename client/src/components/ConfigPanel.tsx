...
const DEFAULT_CONFIGURATION = {
  ...
  binanceMoveForwardMin: 0.000001,
  binanceMoveForwardMax: 0.00000999,
  binanceMoveForwardSignal: "buy" as const,
  binanceMoveForwardKey: "h",
  binanceMoveBackwardMin: 0.000001,
  binanceMoveBackwardMax: 0.00000999,
  binanceMoveBackwardSignal: "sell" as const,
  binanceMoveBackwardKey: "f",
  coinbaseMoveForwardMin: 0.000001,
  coinbaseMoveForwardMax: 0.00000999,
  coinbaseMoveForwardSignal: "buy" as const,
  coinbaseMoveForwardKey: "k",
  coinbaseMoveBackwardMin: 0.000001,
  coinbaseMoveBackwardMax: 0.00000999,
